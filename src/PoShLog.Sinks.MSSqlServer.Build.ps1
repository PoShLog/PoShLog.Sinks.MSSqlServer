...
$moduleName = 'PoShLog.Sinks.MSSqlServer'
...
task BuildDependencies {
	...
	Build-Dependencies '.\Dependencies_ps.csproj' -ModuleDirectory $PSScriptRoot -OutputFolderName 'lib\net461' -IsExtensionModule
	Build-Dependencies '.\Dependencies_pscore.csproj' -ModuleDirectory $PSScriptRoot -OutputFolderName 'lib\netstandard20' -IsExtensionModule
}
